...
class CheckSolutionEquivalence extends TestCase {
...
//		int viewNo=71;
		for(int viewNo=47; viewNo<140; viewNo++)
		{
			...
			IndexViews views = new IndexViews(new File(data.getAbsolutePath()+"/"+"view_"+1+".txt"), viewNo);
			GQR g = new GQR(new File(data.getAbsolutePath()+"/"+"view_"+10+".txt"),views);
